...
public class SolicitudServiceImpl implements SolicitudService {
     ...
     * Incluye validaciones clave: asegura que el cliente exista y, si se asigna un técnico,
     * verifica que este se encuentre activo para poder procesar la solicitud.
     */
    @Override
     ...
     * Al igual que en la creación, verifica la existencia del cliente y el estado activo del técnico.
     */
    @Override
